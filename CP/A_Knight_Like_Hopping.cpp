...
set<pair<int, int>> moves = {mp(1,6), mp(1,8),mp(2, 7),mp(2,9), mp(3,4),mp(3,8),mp(4,3),mp(4,9),mp(6,7),mp(6,1), mp(8,1), mp(8,3), mp(9,2),mp(9, 4)};
void solve()
{
    int n,m,k;
    cin>>n>>m>>k;
    string s;
    cin>>s;
    vector<vector<vector<int>>> v(n+1, vector<vector<int>>(m))
